...
namespace CrossfireSW.SolidWorks.Addin
{
    /// <summary>
    /// Summary description for CrossfireSW.SolidWorks.Addin.
    /// </summary>
    [Guid("8972a5fb-6716-4562-91f5-df7adfe950da"), ComVisible(true)]
    [SwAddin(
        Description = "CrossfireSW.SolidWorks.Addin description",
        Title = "CrossfireSW.SolidWorks.Addin",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("CrossfireSW.SolidWorks.Addin.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("CrossfireSW.SolidWorks.Addin.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("CrossfireSW.SolidWorks.Addin.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("CrossfireSW.SolidWorks.Addin.MainIconSmall.bmp", thisAssembly);
